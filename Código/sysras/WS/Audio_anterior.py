    ...
    def procesarMensaje(self,mensaje):
        ...
        if arrayMensaje[0]=="1CENT":
            ...
            if arrayMensaje[1] == "Uber":
                ...
                notificacion = "Se Reporta un posible robo a ciudadano, activación de alerta desde Aplicación en el número registrado" + arrayMensaje[3]
                ...
                query = "SELECT idUsr FROM usuario WHERE identificadorUsr = '" + str(arrayMensaje[3]) + "'"
            elif arrayMensaje[1] == "BPP":
                notificacion= "Se reporta activación por seguridad perimetral en vehiculo "+ arrayMensaje[3] + " color " + arrayMensaje[9] 
            else:
